        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorStatus = table.Column<string>(type: "varchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubCategoryId = table.Column<short>(type: "smallint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    SubCategoryStatus = table.Column<string>(type: "varchar(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AuthorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FollowedAuthorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FollowerId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Followers", x => new { x.AuthorId, x.FollowedAuthorId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Followers_Authors_FollowedAuthorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Followings_Authors_FollowedAuthorId",
                        column: x => x.FollowedAuthorId,
                        principalTable: "Authors",
                        principalColumn: "AuthorId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostStatus = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    AuthorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CategoryId = table.Column<short>(type: "smallint", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookmarks", x => new { x.PostId, x.AuthorId });
                    table.ForeignKey(
                        name: "FK_Bookmarks_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "AuthorId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => new { x.PostId, x.AuthorId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostSubCategory", x => new { x.PostId, x.SubCategoriesId });
                    table.ForeignKey(
                        name: "FK_PostSubCategory_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "PostId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostSubCategory_SubCategories_SubCategoriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReadingLists_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "AuthorId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommentLikes_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "AuthorId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Followings_FollowedAuthorId",
                table: "Followings",
                column: "FollowedAuthorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostSubCategory_SubCategoriesId",
                table: "PostSubCategory",
